...
from website.views import product_filter, product_delete, product_approve, admin_upload_view, notice_upload_view
...
urlpatterns = [
    ...
    path('upload/notice', notice_upload_view, name="noticeupload"),
